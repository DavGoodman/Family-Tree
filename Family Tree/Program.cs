namespace Family_Tree
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var metteMarit = new Person { Id = 4, FirstName = "Mette-Marit", DateOfBirth = 1973 };
            var marius = new Person { Id = 5, FirstName = "Marius", LastName = "Borg Høiby", DateOfBirth = 1997 };
            var harald = new Person { Id = 6, FirstName = "Harald", DateOfBirth = 1937 };
            var sonja = new Person { Id = 7, FirstName = "Sonja", DateOfBirth = 1937 };
            var olav = new Person { Id = 8, FirstName = "Olav", DateOfBirth = 1903 };
